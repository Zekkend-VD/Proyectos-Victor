...
if "fecha1" in form and "fecha2" in form:
    fecha1_str = form.getvalue("fecha1")
    fecha2_str = form.getvalue("fecha2")
    if fecha1_str and fecha2_str:
        try:
            ...
            resultado = f"<div class='result-card'><p>📅 Días de diferencia: <strong>{diferencia}</strong></p></div>"
        except:
            resultado = "<div class='result-card error'>Error en el formato de fecha</div>"
    else:
        resultado = "<div class='result-card error'>Por favor selecciona ambas fechas</div>"
...
<head>
    ...
    <title>Ejercicio 11 — Días entre fechas</title>
...
<body>
    <div class="container">
        <h1>📆 Ejercicio 11 — Días entre fechas</h1>
        <form method="post">
